...
//        tree[treeIndex] = tree[leftTreeIndex] + tree[rightTreeIndex];
    ...
    /**
     * 在以treeIndex为根的线段树中，[l...r]的范围里，搜索返回区间[queryL, queryR]的值
     * @param treeIndex 线段树的某个根节点的索引
     * @param l 根节点表示区间的左索引
     * @param r 根节点表示区间的右索引
     * @param queryL 表示查询的区间左索引
     * @param queryR 表示查询的区间右索引
     * @return 查找到的结果
     */
    ...
    // 针对treeIndex为根的线段树[l...r]中，将index位置更新为e
